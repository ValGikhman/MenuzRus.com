...
INSERT INTO Categories (CustomerId, Name,Description,Side, Monitor) VALUES(@CustomerId, 'Pizza', 'Additional vegetable toppings $2, Lamb topping $3, Any other meat topping $3','Left',1)
...
INSERT INTO Categories (CustomerId, Name,Description,Side, Monitor) VALUES(@CustomerId, 'Soups', '','Right',1)
	SELECT @id = SCOPE_IDENTITY()
...
INSERT INTO Categories (CustomerId, Name,Description,Side, Monitor) VALUES(@CustomerId, 'Salads', '','Left',1)
	SELECT @id = SCOPE_IDENTITY()
...
INSERT INTO Categories (CustomerId, Name,Description,Side, Monitor) VALUES(@CustomerId, 'Sides', '','Right',1)
	SELECT @id = SCOPE_IDENTITY()
    INSERT INTO Items (CategoryId, Name, Description, ShowAsPrice) VALUES(@id, 'Mashed Potato, French Fries, White Rice', '','$3')

-- 2 Monitor
INSERT INTO Categories (CustomerId, Name,Description,Side, Monitor) VALUES(@CustomerId, 'Sandwiches', '*Platters include home fries and pickles $8,50 Sandwich: $7','Left',2)
	SELECT @id = SCOPE_IDENTITY()
...
INSERT INTO Categories (CustomerId, Name,Description,Side, Monitor) VALUES(@CustomerId, 'Pastas', '', 'Left',2)
	SELECT @id = SCOPE_IDENTITY()
...
INSERT INTO Categories (CustomerId, Name,Description,Side, Monitor) VALUES(@CustomerId, 'Wings', '', 'Left',2)
	SELECT @id = SCOPE_IDENTITY()
    INSERT INTO Items (CategoryId, Name, Description, ShowAsPrice) VALUES(@id, 'Buffalo, BBQ, Garlic', '','8 Wings $6 14 Wings $10 22 Wings $15')

INSERT INTO Categories (CustomerId, Name,Description,Side, Monitor) VALUES(@CustomerId, 'Desserts', '', 'Left',2)
	SELECT @id = SCOPE_IDENTITY()
...
INSERT INTO Categories (CustomerId, Name,Description,Side, Monitor) VALUES(@CustomerId, 'Beverages', '', 'Right',2)
	SELECT @id = SCOPE_IDENTITY()
